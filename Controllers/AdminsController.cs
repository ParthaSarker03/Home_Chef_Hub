...
namespace HomeChefHub.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Email,PhoneNo")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,Name,Email,PhoneNo")] Admin admin)
        {
            if (id != admin.ID)
            {
                return NotFound();
